...
namespace CardDecks
{
    public partial class DeckOfCard : Form
    {
        Deck deck1;
        Deck deck2;
        ...
        private void moveToDeck1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (deck2.Count > 0) { deck1.Add(deck2.Deal(listBox2.SelectedIndex)); }
            }
            RedrawDeck(1);
            RedrawDeck(2);
        ...
        private void moveToDeck2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (deck1.Count > 0) { deck2.Add(deck1.Deal(listBox1.SelectedIndex)); }
            }
            RedrawDeck(1);
            RedrawDeck(2);
        }
        ...
        private void ResetDeck(int DeckNumber)
        {
            ...
            if (DeckNumber == 1)
            {
                int numberOfCard = random.Next(1, 11);
